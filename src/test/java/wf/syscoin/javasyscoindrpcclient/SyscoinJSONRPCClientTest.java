...
public class SyscoinJSONRPCClientTest {

    class MyClientTest extends SyscoinJSONRPCClient {
    ...
    public void signRawTransactionTest() throws Exception {
        client = new MyClientTest(false, "signrawtransaction", null,
                                    "{\n" +
                                            ...
                                            "  \"complete\": true\n" +
                                            "}\n");
        LinkedList<SyscoindRpcClient.ExtendedTxInput> inputList = new LinkedList<SyscoindRpcClient.ExtendedTxInput>();
